...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="text-align: right">ایجاد حساب کاربری</div>
                ...
                <div class="card-body" style="text-align: right">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row" style="place-content:center">
                            ...
                            <label for="password-confirm" class="col-md-2 col-form-label text-md-right">تکرار رمز عبور</label>
                        </div>
